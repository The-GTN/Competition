 ...
 * @version 05/10/2020
 */
 public class TwoFirstFilter implements Filter {

   /**
    * Creates the filter
    */
   public TwoFirstFilter() {
     super();
   }
   ...
   public List<Competitor> select(List<Map<Competitor, Integer>> rankings) {
     return Filter.selectTheFirst(rankings,2);
   }
   ...
   public boolean maySelect(int nbgroups, int nbmembers) {
     return Filter.isPowerOfTwo(nbgroups,nbmembers,2);
   }
